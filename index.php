...
{
$icstudent = mysqli_real_escape_string($con,$_POST['icstudent']);
$password  = mysqli_real_escape_string($con,$_POST['password']);

$res = mysqli_query($con,"SELECT * FROM Student WHERE icstudent = '$icstudent'");
$row=mysqli_fetch_array($res,MYSQLI_ASSOC);
if ($row['password'] == $password)
{
$_SESSION['studentSession'] = $row['icstudent'];
?>
...
//INSERT
$query = " INSERT INTO Student (  icstudent, password, FirstName, LastName, Gender,   Email ,  DOB)
VALUES ( '$icstudent', '$password', '$studentFirstName', '$studentLastName', '$studentGender', '$studentEmail', '$studentDOB' ) ";
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/logo-white-1.png" style="margin-top: -20px;height: 60px;"></a>
                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    <label class="sr-only" for="icstudent">Email</label>
                                                    <input type="text" class="form-control" name="icstudent" placeholder="IC Number" required>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="studentFirstName" value="" class="form-control input-lg" placeholder="First Name" required />
                                            </div>
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="studentLastName" value="" class="form-control input-lg" placeholder="Last Name" required />
                                            </div>
                                        </div>
                                        
                                        <input type="text" name="studentEmail" value="" class="form-control input-lg" placeholder="Your Email"  required/>
                                        <input type="number" name="icstudent" value="" class="form-control input-lg" placeholder="Your IC Number"  required/>
        ...
        <section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite">
            <div class="container" style="margin-top: 180px;">
                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        <h2 style="margin-left:15px;color:#05496b">Make appointment today !</h2>
                        <p style="margin-left:15px; color:#05496b">This is Teachers's Schedule. Please <span class="label label-danger">login</span> to make an appointment. </p>
                        ...
                        <div class="input-group" style="margin-bottom:10px;">
                            ...
                            <input class="form-control" id="date" name="date" value="<?php echo date("Y-m-d")?>" onchange="showUser(this.value)" style="color: white;"/>
                        </div>
