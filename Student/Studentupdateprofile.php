...
$res=mysqli_query($con,"SELECT * FROM Student WHERE icStudent=".$_SESSION['patientSession']);
...
$res=mysqli_query($con,"UPDATE patient SET FirstName='$FirstName', LastName='$LastName', Gender='$Gender', Address='$Address', Phone=$Phone, Email='$Email' , DOB='$DOB' WHERE icPatient=".$_SESSION['patientSession']);
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="Studentprofile.php"><i class="fa fa-fw fa-bar-chart-o"></i> Profile</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="Studentdashboard-rtl.html"><i class="fa fa-fw fa-dashboard"></i> RTL Dashboard</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
                                ...
                                <div class="panel panel-info">
                                    <div class="panel-heading">
                                        <h2 class="panel-title"><?php echo $userRow['FirstName']; ?> <?php echo $userRow['LastName']; ?></h2>
                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input class="form-control" id="DOB" name="patientDOB" placeholder="MM/DD/YYYY" type="text" value="<?php echo $userRow['DOB']; ?>"/>
                                                                        </div>
                                                                    </div>
                                                                </td>
