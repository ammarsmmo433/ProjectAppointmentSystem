...
$res=mysqli_query($con,"SELECT * FROM Student WHERE icStudent=".$usersession);
...
">Make appointment today!</h2>
    ...
    color: white;
" id="date" name="date" value="<?php echo date("Y-m-d")?>" onchange="showUser(this.value)"/>
							</div>
						</div>
						<!-- date textbox end -->
						<!-- script start -->
						...
						<!-- <div class="container"> -->
						<div class="container">
							<div class="row" style="color: #eac55b;">
		...
		<div class="copyright-bar bg-black">
			<div class="container">
				<p class="pull-left small">© svu project</p>
			</div>
		</div>
		<!-- footer end -->
