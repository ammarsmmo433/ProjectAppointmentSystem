...
$usersession = $_SESSION['studentSession'];
$res=mysql_query("SELECT * FROM Student WHERE icStudent=".$usersession);
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="Studentprofile.php?StudentEmail=<?php echo $userRow['Email']; ?>"><i class="fa fa-fw fa-bar-chart-o"></i> Profile</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="Studentdashboard-rtl.php"><i class="fa fa-fw fa-dashboard"></i> RTL Dashboard</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div id="txtHint"><b> Teacher schedule will be list here</b></div>
