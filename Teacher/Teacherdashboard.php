                    ...
                    <div class="panel panel-primary filterable table-responsive">
                       ...
                       <div class="panel-heading table-responsive">
                        ...
                        <table class="table table-hover table-bordered table-responsive">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="student Ic" disabled></th>
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                echo "<tr class='$status'>";
                                    echo "<td>" . $appointment['studentIc'] . "</td>";
                                    ...
                                    echo "<td><span class='fa fa-".$icon." fa-2x' aria-hidden='true'></span>".' '."". $appointment['status'] . "</td>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$appointment['appId']."' class='delete'><span class='fa fa-trash fa-2x' aria-hidden='true'></span></a>
                            </td>";
