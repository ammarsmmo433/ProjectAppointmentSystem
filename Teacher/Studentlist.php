                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-calendar"></i> Student List
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-primary filterable table-responsive">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($sRow=mysqli_fetch_array($result)) {
                                ...
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $sRow['icstudent'] . "</td>";
                                    echo "<td>" . $sRow['FirstName'] . "</td>";
                                    echo "<td>" . $sRow['LastName'] . "</td>";
                                    echo "<td>" . $sRow['password'] . "</td>";
                                    echo "<td>" . $sRow['Phone'] . "</td>";
                                  echo "<td>" . $sRow['Email'] . "</td>";
                                    echo "<td>" . $sRow['Gender'] . "</td>";
                                    echo "<td>" . $sRow['DOB'] . "</td>";
                                    echo "<td>" . $sRow['Address'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$sRow['icstudent']."' class='delete'><span class='fa fa-trash fa-2x' aria-hidden='true'></span></a>
                            </td>";
