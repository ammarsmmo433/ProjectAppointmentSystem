                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered table-responsive">
                            ...
                            while ($tschedule=mysqli_fetch_array($result)) {
                                
                              
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $tschedule['scheduleId'] . "</td>";
                                    echo "<td>" . $tschedule['scheduleDate'] . "</td>";
                                    echo "<td>" . $tschedule['scheduleDay'] . "</td>";
                                    echo "<td>" . $tschedule['startTime'] . "</td>";
                                    echo "<td>" . $tschedule['endTime'] . "</td>";
                                    echo "<td>" . $tschedule['bookAvail'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$tschedule['scheduleId']."' class='delete'><span class='fa fa-trash fa-2x' aria-hidden='true'></span></a>
                            </td>";
